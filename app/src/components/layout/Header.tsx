    ...
    <div className="flex items-center justify-between p-6 border-b border-border">
      <div className="flex items-center space-x-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="min-w-[150px] justify-between">
              {t('common.header.selectDatabase')}
              <ChevronDown className="w-4 h-4 opacity-50" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="start" className="w-[200px]">
            <DropdownMenuItem disabled className="text-muted-foreground">
              {t('common.header.noDatabasesConnected')}
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        ...
        <Button onClick={onConnectDatabase} className="bg-primary hover:bg-primary-dark">
          {t('common.header.connectDatabase')}
        </Button>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <a 
          ...
          title={t('common.header.viewOnGitHub')}
        >
          <svg 
            width="16" 
            height="16" 
